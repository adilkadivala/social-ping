      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Deep insights into your social media mentions and engagement.
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {[
              { keyword: 'SocialPing', mentions: 234, sentiment: 'positive', growth: '+12%' },
              { keyword: 'social monitoring', mentions: 189, sentiment: 'positive', growth: '+8%' },
              { keyword: 'brand tracking', mentions: 156, sentiment: 'neutral', growth: '+15%' },
              { keyword: 'mention alerts', mentions: 134, sentiment: 'positive', growth: '+5%' },
              { keyword: 'social analytics', mentions: 98, sentiment: 'positive', growth: '+22%' }
            ].map((item, index) => (
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Users with highest reach mentioning you</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">{influencer.mentions} mentions</Badge>
                </div>
              ))}
            </div>
          </CardContent>
