import { ArrowRight, Bell, Search, BarChart3, Shield, Zap, Twitter, MessageSquare, Star, Users, TrendingUp, Globe, CheckCircle, Play } from "lucide-react";
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Get instant alerts when someone mentions your name, product, or brand across social media platforms. 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Mentions Tracked</div>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Comprehensive social media monitoring with real-time alerts and powerful analytics.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <Card className="lg:col-span-2 lg:row-span-2 p-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
              <CardHeader className="p-0 mb-6">
                ...
                <CardTitle className="text-2xl">Multi-Platform Monitoring</CardTitle>
                <CardDescription className="text-base">
                  Track mentions across Twitter, Reddit, LinkedIn, and YouTube comments in real-time.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="p-0">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Marketing Director, GrowthCo</div>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of businesses already using SocialPing to stay ahead of the conversation.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Monitor your online presence with confidence. Never miss an important mention again.
              </p>
            </div>
